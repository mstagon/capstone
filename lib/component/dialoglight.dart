...
class LightDetailDialog extends StatelessWidget {
                    ...
                    ElevatedButton(
                      onPressed: () {
                        ...
                        if (moneyProvider.usermoney >= price) {
                          ...
                          final purchasePLight = Provider.of<PurchasePLight>(context, listen: false);
                          purchasePLight.addPurchasedItem(PurchasedLight(
                              imageName: imageName,
...
Future<void> showLightDetailDialog(BuildContext context, LightDetailDialog dialog) async {
  return showDialog(
    context: context,
